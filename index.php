...
經查證未下架之商品，PChome 也將立即下架 。感謝大家的協助， 我們一起共同防疫為大家的健康而努力 。"
				...
				break;
			default:
			getPushData($type, $token, $inputJson);
					...
					<form class="container text-center" action="index.php" method="post">
						...
						<div class="form-row border-top pt-3">
							...
							<div class="col-12 form-group row">
								...
								<div class="col-sm-10">
									<textarea class="form-control" name="push-json" placeholder="請輸入推播內容" rows="4" cols="50"><?php echo !empty($inputJson) ? print_r($inputJson) : '';?></textarea>
								</div>
							</div>
						</div>
